            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mb-2 mb-lg-0">
                        ...
                        <p class="mb-3">Công ty TRONG NGHIA CLOTHES STORE. Hãy liên hệ với chúng tôi nếu bạn có
                            thắc mắc, hay vấn đề gì muốn giải quyết. Chúng tôi luôn sẵn sàng giải đáp thắc mắc của bạn.
                            TRONG NGHIA CLOTHES STORE xin cảm ơn!!! </p>
                        <div class="row">
                            <div class="col-sm-7">
                                <div class="contact-info">
                                    ...
                                    <ul class="contact-list">
                                        ...
                                        <li>
                                            ...
                                            <a href="mailto:#">info@phamtrongnghiadt@gmail.com</a>
                                        </li>
                                    </ul><!-- End .contact-list -->
