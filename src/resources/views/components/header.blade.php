...
<header class="header header-intro-clearance header-3">
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-left">
                <a href="tel:#"><i class="icon-envelope"></i>phamtrongnghia@gmail.com</a>
            </div><!-- End .header-left -->
        ...
        <div class="container">
            <div class="header-left">
                ...
                <a href="" class="logo" style="text-align: center; display: block;">
                    ...
                    <p style="margin: 0; color: rgba(255, 255, 255, 0.864)"><b>TRONG NGHIA </b></p>
                    <p style="margin: 0; color: rgba(255, 255, 255, 0.864)"><b>CLOTHES STORE</b></p>
                </a>
