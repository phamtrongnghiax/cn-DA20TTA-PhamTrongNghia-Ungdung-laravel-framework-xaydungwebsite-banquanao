...
class CheckoutController extends Controller
{
    ...
    public function order_place(Request $request)
    {
        ...
        $data = array();
        $data['payment_method'] = $request->payment_option; // Không cần dòng này nữa

        // Bạn có thể loại bỏ đoạn này hoặc giữ lại tùy vào nhu cầu của bạn
        ...
        // $order_data['payment_id'] = $payment_id; // Bạn có thể thêm lại nếu cần
        $order_data['payment_id'] = 0; // Hoặc có thể gán giá trị mặc định cho payment_id
        ...
        // Giờ bạn không cần kiểm tra phương thức thanh toán nữa
        // Cứ thực hiện tiếp theo các công việc cần thiết cho đặt hàng
    ...
    public function print_order_convert($checkoutcode)
    {
        ...
        $output .= '<tr>
                        ...
                        <br>
                        <h3><span>PHAM TRONG NGHIA STORES </span> <br> CẢM ƠN QUÝ KHÁCH ĐÃ MUA SẮM TẠI CỬA HÀNG!  </h3>
                    </body>
                </html>';
        return $output;
    }
